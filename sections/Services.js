...
import { ServicesData } from '../data/ServicesData'; // Adjust the import path as necessary
import Image from 'next/image';

export const Services = () => {
  return (
    <div className="container px-4 py-10 justify-center items-center w-full">
    <div className='flex justify-center items-center py-14'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {ServicesData.map((service, index) => (
          <div key={index} className="border shadow-lg p-4 w-3/4 h-80 flex flex-col justify-center items-center">
